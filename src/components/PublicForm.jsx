  ...
  return (
    <div className="public-form-page">
                ...
                <div className="value-card highlighted">
                  ...
                  {isPixCash && packageValue > 0 && (
                    <span className="text-sm text-muted">
                      Valor original: R$ {packageValue.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} · 5% de desconto aplicado
                    </span>
                  )}
                </div>
                {isPixCash && packageValue > 0 && (
      ...
      <style>{`
        ...
        .selection-item:hover, .selection-item.selected { border-color: var(--accent); background-color: #fff; transform: translateY(-2px); box-shadow: var(--shadow-md); }
        ...
        .extra-price { color: var(--primary); font-size: 0.9375rem; white-space: nowrap; margin-left: 1rem; }
        .extra-hour-card {
          border: 1.5px solid var(--border);
          border-radius: var(--radius-sm);
        ...
        .selection-card:hover, .selection-card.selected { border-color: var(--accent); background-color: #fff; }
        ...
        .value-card.highlighted { border-color: var(--accent); background-color: #fff; box-shadow: var(--shadow-sm); }
        ...
        .form-submit-area { background-color: var(--primary); border-radius: var(--radius); padding: 3rem; color: #fff; margin-top: 4rem; }
        ...
        .checkmark { flex-shrink: 0; width: 22px; height: 22px; border: 2px solid rgba(255,255,255,0.3); border-radius: 4px; position: relative; transition: 0.2s; margin-top: 2px; }
        ...
        .btn-full { width: 100%; }
        .modal-backdrop { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.6); backdrop-filter: blur(4px); display: flex; align-items: center; justify-content: center; z-index: 1000; padding: 1.5rem; }
        .modal-content { background: #fff; border-radius: var(--radius); width: 100%; max-width: 500px; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden; position: relative; }
        ...
        .modal-pkg-price-badge { display: inline-block; padding: 0.5rem 1rem; background: var(--primary); color: #fff; border-radius: var(--radius-full); font-weight: 700; font-size: 0.875rem; }
        ...
        .highlight-block { background: var(--bg-page); padding: 1.25rem; border-radius: var(--radius-sm); border-left: 4px solid var(--accent); }
        .modal-footer { padding: 1.5rem; border-top: 1px solid var(--border); display: flex; flex-direction: column; gap: 0.75rem; }
