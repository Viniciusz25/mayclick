    ...
    <div className="home-luxury-wrapper">
      ...
      <main className="luxury-inner-page" style={{ paddingTop: '75px' }}>
        ...
        <section style={{
          position: 'relative',
          minHeight: '300px',
          backgroundImage: `url(${album.cover_image_url || category.cover_image_url || 'https://images.unsplash.com/photo-1511285560929-80b456fea0bc?auto=format&fit=crop&w=1920&q=80'})`,
